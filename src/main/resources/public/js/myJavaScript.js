    ...
    methods: {
        ...
        addRouteToUser:function()
        {
            for (var i=0; i<4; i++){
                ...
                console.log("Name: " + app.bestRouteAddress[i])
            }
            
            fetch(apiUri + "saveRoute?username=" + this.username
            + "&nameAddress1"+"="+app.bestRouteName[0]
            + "&address1"+"="+app.bestRouteAddress[0]
            + "&nameAddress2"+"="+app.bestRouteName[1]
            + "&address2"+"="+app.bestRouteAddress[1]
            + "&nameAddress3"+"="+app.bestRouteName[2]
            + "&address3"+"="+app.bestRouteAddress[2]
            + "&nameAddress4"+"="+app.bestRouteName[3]
            + "&address4"+"="+app.bestRouteAddress[3],
            {
                method: 'PUT',
                body: JSON.stringify()
